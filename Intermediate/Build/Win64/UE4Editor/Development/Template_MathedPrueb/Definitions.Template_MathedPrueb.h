#undef TEMPLATE_MATHEDPRUEB_API
...
#define UE_PROJECT_NAME Template_MathedPrueb
#define UE_TARGET_NAME Template_MathedPruebEditor
#define UE_MODULE_NAME "Template_MathedPrueb"
...
#define TEMPLATE_MATHEDPRUEB_API DLLEXPORT
